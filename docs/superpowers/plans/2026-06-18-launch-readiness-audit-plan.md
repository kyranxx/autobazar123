...
- Real signup confirmation-link login is not verified.
- Real password-reset emailed-link password update is not verified. Real recovery-token consumption is verified locally through the browser, and real password-reset email delivery is verified through Resend/Gmail.
