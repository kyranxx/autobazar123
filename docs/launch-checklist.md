...
- `npx vitest run src/app/api/cron/cleanup-sold/route.test.ts src/app/api/cron/process-email-jobs/route.test.ts src/app/api/cron/send-alerts/route.test.ts src/app/api/cron/expire-ads/route.test.ts src/lib/fallbacks/registry.test.ts src/lib/env.test.ts` passed 13/13 tests, adding `cleanup-sold` route coverage for cron auth rejection, successful old-sold-ad hiding/cache revalidation, and DB update failure without cache revalidation.
