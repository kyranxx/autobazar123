...
| Brands/models plan | `docs/ad-supply-launch-plan.md` chooses current taxonomy plus manual normalization; no JATO for launch. | Done | User still needs to accept the plan. |
