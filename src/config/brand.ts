export const BRAND_NAME = "AutoNinja";
const BRAND_DOMAIN = "www.autoninja.sk";
...
export const BRAND_SOCIAL_CHANNELS = [
  {
    key: "facebook",
    label: "Facebook",
    iconPath:
...
export const BRAND_SOCIAL_PROFILE_URLS = Object.values(BRAND_SOCIAL_LINKS).filter(
