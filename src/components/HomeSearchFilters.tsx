...
export default function HomeSearchFilters() {
    ...
    }, [query, selectedBrand, selectedModel, selectedFuel, selectedTransmission, priceFrom, priceTo, yearFrom, yearTo, hasRedirected]);
    ...
    const hasFilters = selectedBrand || selectedModel || priceFrom || priceTo || yearFrom || yearTo || selectedFuel || selectedTransmission;
