...
function HeroSearchBar() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <div
        className={`relative flex items-center gap-3 p-2 rounded-2xl border-2 transition-all duration-300 bg-white shadow-2xl ${
          isFocused
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
        ...
        {["Škoda Octavia", "BMW", "Audi A4", "Mercedes", "VW Golf"].map(
          (suggestion) => (
            <button
              key={suggestion}
              type="button"
