    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <ChevronDownIcon className={cn("w-3.5 h-3.5 text-text-tertiary transition-transform", isOpen && "rotate-180")} />
            </button>
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive ? "bg-background-secondary text-text-primary" : "text-text-secondary hover:bg-background-secondary"
                                )}
                            >
                                <Flag className="w-4 h-3 object-cover shrink-0" />
                                <span className="font-medium flex-1">{localeNames[locale]}</span>
                                {isActive && (
