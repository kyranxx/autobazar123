...
function CarCard({ car, index, fuelLabel, transmissionLabel }: CarCardProps) {
    ...
    return (
        <Link
            href={`/auto/${car.id}`}
            className={`group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-sm hover:border-accent/40 hover:shadow-xl transition-all duration-300 opacity-0 animate-slide-in-up car-card-item`}
