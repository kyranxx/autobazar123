...
export function findBrandInQuery(query: string, availableBrands: string[]): string | null {
...
export function findModelInQuery(query: string, availableModels: string[], brandToRemove?: string): string | null {
