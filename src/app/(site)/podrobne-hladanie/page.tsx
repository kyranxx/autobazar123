        ...
        fallback={
          <main className="market-page min-h-screen bg-background pb-16 pt-8">
            <div className="container-main">
              ...
              <div className="mt-6 h-12 w-80 animate-pulse rounded-lg bg-background-secondary" />
              <div className="mt-4 h-40 animate-pulse rounded-2xl bg-background-secondary" />
            </div>
          </main>
        }
      >
