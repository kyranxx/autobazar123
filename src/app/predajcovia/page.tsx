...
export const metadata: Metadata = {
    ...
    description: "Zoznam overených predajcov vozidiel na Autobazar123. Nakupujte od dôveryhodných predajcov.",
};
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="py-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-secondary max-w-2xl mx-auto">
                            Nakupujte od dôveryhodných predajcov s overenou históriou predaja a pozitívnymi recenziami.
                        </p>
                    </div>
                        ...
                        {VERIFIED_DEALERS.map((dealer) => (
                            ...
                            >
                                ...
                                <div className="mt-4 grid grid-cols-3 gap-4 text-center">
                                    ...
                                    <div>
                                        <p className="text-lg font-bold text-accent">⭐ {dealer.rating}</p>
