...
function CtaCard({
    ...
    return (
        <div
            className={
                isDark
                    ? "relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-900 text-white"
                    : "card p-8 bg-white"
            }
        >
            {isDark && (
                <>
                    ...
                    <div className="absolute -bottom-24 -left-16 w-56 h-56 bg-amber-400/20 rounded-full blur-3xl" />
                </>
            )}
            <div className="relative">
                <p className={isDark ? "eyebrow text-slate-300 mb-3" : "eyebrow mb-3"}>{eyebrow}</p>
                <h3 className={isDark ? "text-2xl font-semibold mb-3" : "text-2xl font-semibold text-text-primary mb-3"}>{title}</h3>
                <p className={isDark ? "text-slate-300 mb-6" : "text-text-tertiary mb-6"}>{description}</p>
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Link
                        ...
                        className={
                            isDark
                                ? "btn-secondary w-full sm:w-auto text-white border-white/30 bg-white/5 hover:border-white/50 hover:bg-white/10"
