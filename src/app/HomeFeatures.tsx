        ...
        <div className="container-main">
          <div className="text-center mb-12">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              Tri kroky k vášmu novému autu — rýchlo, prehľadne a bez zbytočných
              komplikácií.
            </p>
          </div>
      ...
      <section className="section section-muted">
        <div className="container-main">
          <div className="text-center mb-10">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              Overujeme predajcov, chránime kupujúcich a uľahčujeme
              financovanie.
            </p>
          </div>
      ...
      <section className="section">
        <div className="container-main">
          <div className="text-center mb-10">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              Skutočné príbehy ľudí, ktorí si u nás našli auto alebo úspešne
              predali.
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <p className={cn("eyebrow mb-3", isDark && "text-text-muted")}>
          {eyebrow}
        </p>
        <h3
          className={cn(
