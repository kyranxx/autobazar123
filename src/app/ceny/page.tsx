            ...
            <main className="pt-20 pb-16">
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
                            {CREDIT_PACKS.map((pack) => (
                                ...
                                >
                                    ...
                                    <p className="text-sm text-secondary">{tDashboard("creditsWord")}</p>
                        ...
                        <div className="rounded-2xl border border-border overflow-hidden">
                            <table className="w-full">
                                <thead className="bg-surface">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-primary">{t("action")}</th>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-primary">{t("description")}</th>
                                        <th className="px-6 py-4 text-right text-sm font-semibold text-primary">{t("price")}</th>
                                    </tr>
                                </thead>
                                <tbody>
                    ...
                    <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-accent/10 to-transparent border border-accent/20">
                        <h2 className="text-xl font-semibold text-primary">{t("readyToStart")}</h2>
