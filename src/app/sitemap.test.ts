...
describe("sitemap", () => {
  ...
  it("builds Romanian sitemap URLs and filters Romanian inventory", async () => {
    ...
    expect(urls).toContain("https://www.autoninja.ro/masini");
    expect(urls).toContain("https://www.autoninja.ro/dealeri");
    expect(urls).toContain("https://www.autoninja.ro/preturi");
    expect(urls).toContain("https://www.autoninja.ro/despre-noi");
    expect(urls).toContain("https://www.autoninja.ro/dacia");
    expect(urls).toContain("https://www.autoninja.ro/masina/ad-1-dacia-duster-2020");
    expect(urls).not.toContain("https://www.autoninja.ro/vysledky");
    expect(urls).not.toContain("https://www.autoninja.ro/predajcovia");
