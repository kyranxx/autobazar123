...
export const metadata: Metadata = {
    ...
    description: "Obchodné podmienky používania platformy Autobazar123.",
};
                    ...
                    <div className="prose prose-lg max-w-none text-secondary">
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                ...
                                platformy Autobazar123 (ďalej len &quot;Prevádzkovateľ&quot;) a
                                používateľmi služby (ďalej len &quot;Používateľ&quot;).
                            </p>
                            <p className="mt-2">
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                ...
                                umožňuje Používateľom zverejňovať inzeráty, vyhľadávať vozidlá a
                                kontaktovať predajcov.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Používateľ je zodpovedný za bezpečnosť svojich prihlasovacích
                                    údajov.
                                </li>
                                <li>
                                    Jeden Používateľ môže mať len jeden účet (fyzická osoba) alebo
                                    jeden dealer účet (firma).
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Ceny jednotlivých akcií (zverejnenie, topovanie, zvýraznenie)
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Fotografie musia zodpovedať skutočnému stavu vozidla.
                                </li>
                                <li>
