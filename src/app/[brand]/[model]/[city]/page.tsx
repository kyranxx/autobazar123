...
const CITIES: Record<string, { name: string; region: string }> = {
    ...
    "banska-bystrica": { name: "Banská Bystrica", region: "Banskobystrický kraj" },
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-3 text-lg text-secondary max-w-2xl">
                            Najlepšie ponuky {brandName} {modelName} v okolí mesta {cityName}
                            a {cityData.region}. Lokálni predajcovia s možnosťou obhliadky.
                        </p>
                    </div>
                    ...
                    <div className="mt-16 prose max-w-none">
                        ...
                        <p className="text-secondary">
                            Hľadáte {brandName} {modelName} v okolí {cityName}? Na Autobazar123
                            nájdete overených predajcov z {cityData.region}, ktorí ponúkajú
                            kvalitné vozidlá s možnosťou osobnej obhliadky.
                        </p>
