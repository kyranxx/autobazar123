                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-16 prose max-w-none">
                        ...
                        <p className="text-secondary mb-4">
                            {brandName} {modelName} je jedným z najpopulárnejších modelov na slovenskom trhu.
                            Vďaka svojmu výkonu, spoľahlivosti a moderným technológiám si získal srdcia
                            mnohých slovenských motoristov.
                        </p>
                        <p className="text-secondary mb-4">
                            Na Autobazar123 nájdete široký výber {brandName} {modelName} od súkromných
                            predajcov aj overených autobazárov. Každý inzerát obsahuje detailné informácie
                            o vozidle, fotogalériu a kontakt na predajcu.
                        </p>
...
function generateMockCars(brand: string, model: string, count: number): MockCar[] {
