...
export default function LoginPage() {
    ...
    const handleForgotPassword = async () => {
        if (!email) {
            setError('Zadajte email pre obnovenie hesla')
            return
        }
        ...
        if (error) {
            ...
            setMessage('Odkaz na obnovenie hesla bol odoslaný na váš email')
        }
        setLoading(false)
    }
                ...
                <div className="mt-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-gray-50 text-gray-500">Alebo pokračujte s</span>
                        </div>
                    </div>
