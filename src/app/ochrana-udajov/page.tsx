                    ...
                    <div className="prose prose-lg max-w-none text-secondary">
                        <section className="mb-8">
                            <div className="p-8 rounded-2xl border border-border bg-surface/30">
                                ...
                                <p>
                                    ...
                                    kontaktujte na: <a href="mailto:gdpr@autobazar123.sk" className="text-accent hover:underline font-medium">gdpr@autobazar123.sk</a>
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="mb-8">
                            <div className="p-8 rounded-2xl border border-border bg-surface/30">
                                ...
                                <p className="mt-4">
                                    Pre uplatnenie práv kontaktujte: <a href="mailto:gdpr@autobazar123.sk" className="text-accent hover:underline font-medium">gdpr@autobazar123.sk</a>
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="mb-8">
                            <div className="p-8 rounded-2xl border border-border bg-surface/30">
                                ...
                                <p>
                                    ...
                                    <a href="https://dataprotection.gov.sk" className="text-accent hover:underline font-medium" target="_blank" rel="noopener">
