...
DROP POLICY IF EXISTS "Service role full access to site_admins" ON public.site_admins;
...
CREATE TABLE IF NOT EXISTS public.contact_messages (
  ...
  subject TEXT NOT NULL DEFAULT 'general' CHECK (
    subject IN ('general', 'technical', 'billing', 'partnership')
  ),
