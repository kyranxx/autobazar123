  ...
  const status = runProdRateLimitEnvGuard(
    {
      ...
      NEXT_PUBLIC_APP_URL: "https://autoninja.sk",
      RESEND_API_KEY: "re_test_key",
      EMAIL_FROM: "AutoNinja <noreply@autoninja.sk>",
      EMAIL_REPLY_TO: "support@autoninja.sk",
  ...
  const status = runProdRateLimitEnvGuard(
    {
      ...
      NEXT_PUBLIC_APP_URL: "https://autoninja.ro",
      RESEND_API_KEY: "re_test_key",
      EMAIL_FROM: "AutoNinja <noreply@autoninja.ro>",
      EMAIL_REPLY_TO: "support@autoninja.ro",
      ALGOLIA_SYNC_SECRET: "sync-secret",
    },
    io,
  );
